...
const Signin = () => {
    ...
    return (
        <section className='container flex items-center justify-center w-full xs:h-80vh'>
            <form
            ...
            >
                ...
                <div className='flex w-full'>
                    ...
                    />
                    <button
                        className='flex items-center text-white justify-center w-2/12 transition duration-150 bg-accent border-r border-solid rounded-r border-y border-gray-200 ease hover:bg-accent '
                        onClick={(e) => {
                            e.preventDefault();
                ...
                <button
                    className='flex text-[#A1A1A1] items-center gap-3 px-4 py-2 text-sm align-middle transition-all bg-black border border-solid rounded border-[#2E2E2E] ease hover:text-white hover:bg-accent hover-text-white hover:border-accent'
                    onClick={(e) => {
                        e.preventDefault();
                        signIn("google");
                    }}

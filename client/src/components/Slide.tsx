    ...
    return (
        <div className='outline-none border-none relative'>
            <div className='absolute right-[30px] md:right-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none'>
                ...
                <div className='bg-accent text-white text-[15px] md:text-[17px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-blackish'>
                    Shop Now
                </div>
            </div>
            <Image
                className='w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-left md:object-right-bottom'
                src={img}
                alt='banner'
                width={2000}
                height={2000}

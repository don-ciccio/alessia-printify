                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={global.text}>
                            We&apos;re preparing everything for delivery and
                            will notify you once your package has been shipped.
                    ...
                    <Section style={paddingY}>
                        <Row>
                            ...
                            >
                                ...
                                you reply to this email, we won&apos;t be able
                                to see it.)
                            </Text>
                        </Row>
                        <Row>
                            <Text style={footer.text}>
                                © Lazy Mondays Co., Inc. All Rights Reserved.
                            </Text>
                        </Row>
                    </Section>
                </Container>
